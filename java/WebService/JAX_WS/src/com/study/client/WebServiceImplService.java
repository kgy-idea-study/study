 ...
 * 
 */
@WebServiceClient(name = "WebServiceImplService", targetNamespace = "http://study.com/", wsdlLocation = "file:/C:/Users/Admin/AppData/Local/Temp/tempdir2183510393642866891.tmp/Webservice_1.wsdl")
    ...
    extends Service
{
    ...
    private final static QName WEBSERVICEIMPLSERVICE_QNAME = new QName("http://study.com/", "WebServiceImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("file:/C:/Users/Admin/AppData/Local/Temp/tempdir2183510393642866891.tmp/Webservice_1.wsdl");
    ...
    public WebServiceImpl getWebServiceImplPort() {
        return super.getPort(new QName("http://study.com/", "WebServiceImplPort"), WebServiceImpl.class);
    }
    ...
    public WebServiceImpl getWebServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://study.com/", "WebServiceImplPort"), WebServiceImpl.class, features);
    }
